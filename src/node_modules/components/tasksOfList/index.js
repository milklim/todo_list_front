            ...
            <div className="w3-row w3-border-left w3-border-right w3-border-bottom task-item" key={task.id}>
                ...
                <div className="w3-col w3-padding-16 w3-right task-edit-btns">
                    <div className="w3-wide">
                        <div className="arrow-up w3-hover-red" onClick={this.moveUp.bind(this, task.id)}></div>
                        <div className="arrow-down w3-hover-text-red" onClick={this.moveDown.bind(this, task.id)}></div>
                        <i className="fa">|</i>
