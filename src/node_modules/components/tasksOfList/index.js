...
class TasksOfList extends Component {
    ...
    moveUp = (taskId) => this.props.taskPositionUp(taskId)
    moveDown = (taskId) => this.props.taskPositionDown(taskId)
            ...
            <div className="w3-row w3-border-left w3-border-right w3-border-bottom task-item" key={task.id}>
                ...
                <div className="w3-col w3-right task-edit-btns">
                    <div className="w3-row">
                        <div class="w3-third w3-border-right w3-padding">
                            <div className="arrow-up" onClick={this.moveUp.bind(this, task.id)}></div>
                            <div className="arrow-down" onClick={this.moveDown.bind(this, task.id)}></div>
                        </div>
                        <div class="w3-third w3-padding">
                            <i className="fa fa-pencil w3-hover-text-black"></i>
                        </div>
                        <div class="w3-third w3-border-left w3-padding">
